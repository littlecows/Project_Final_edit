...
INSERT INTO `activities` (`id`, `name`, `max_hours`) VALUES
(1, 'เกี่ยวกับ การบริจาคร่างกาย', 9),
(2, 'เกี่ยวกับ ทำความสะอาด', 4),
(3, 'เกี่ยวกับ การให้ความรู้', 4),
(4, 'เกี่ยวกับ การบริจาคสิ่งของภายนอกมหาวิทยาลัย', 4),
(5, 'เกี่ยวกับ การดูแล', 6),
(6, 'เกี่ยวกับ อาสาสมัคร (เฉพาะผู้มีบัตรจิตอาสา)', 18),
(7, 'เกี่ยวกับ งานหน่วยงานภายในมหาวิทยาลัย', 18),
(8, 'เกี่ยวกับ การออมเงิน กอช.', 5),
(9, 'เกี่ยวกับ สิ่งแวดล้อม', 4),
(10, 'เกี่ยวกับ หน่วยงานภายนอก', 8),
(11, 'เกี่ยวกับ e-learning', 18),
(12, 'เกี่ยวกับ ช่วยสร้างขาเทียมช่วยผู้พิการ', 18),
(13, 'เกี่ยวกับ ขอขวดเป็นของขวัญ', 18),
(14, 'เกี่ยวกับ รู้รักสามัคคี รักษ์สิ่งแวดล้อม พัฒนาคุณภาพชีวิต', 4),
(15, 'เกี่ยวกับ ความมั่นคง', 8),
(16, 'เกี่ยวกับ กิจกรรม 100 ปี กาชาด', 6),
(17, 'เกี่ยวกับ งานรับปริญญา', 18),
(18, 'เกี่ยวกับ Music Interventions for Enhancing Children Development', 3),
(19, 'เกี่ยวกับ มหกรรมกีฬา สุขภาพดี วิถีไทย', 8),
(20, 'เกี่ยวกับ สถาปนิก 67', 18),
(21, 'เกี่ยวกับ วันพยาบาลสากลและวันงดสูบบุหรี่โลก', 6),
(22, 'เกี่ยวกับ ลอยกระทง', 18);
...
CREATE TABLE `endorsee` (
  `endorser_id` varchar(13) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `father` (
  `father_id` varchar(13) COLLATE utf8mb4_unicode_ci NOT NULL,
  `father_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ชื่อ',
  `father_last_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'นามสกุล',
  ...
  `father_phone_number` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `father_education_level` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `father_school_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `guardian` (
  `guardian_id` varchar(13) COLLATE utf8mb4_unicode_ci NOT NULL,
  `f_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ชื่อ',
  `l_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'นามสกุล',
...
CREATE TABLE `mother` (
  `mother_id` varchar(13) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mother_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ชื่อ',
  `mother_last_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'นามสกุล',
  ...
  `mother_phone_number` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mother_education_level` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mother_school_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `new_user_activities` (`id`, `username`, `activity_name`, `location`, `details`, `image_path`, `created_at`) VALUES
(1, '1103703175319', 'เกี่ยวกับ การบริจาคร่างกาย', 'าา', 'หหห', '../uploads/ER DIAGRAM_page-0001.jpg', '2025-03-19 04:59:33'),
(4, '1103703175319', 'เกี่ยวกับ การบริจาคร่างกาย', 'บ้าน', 'ไม่บอก', '../uploads/messageImage_1670308402138.jpg', '2025-03-19 05:04:41'),
(5, '1103703175319', 'เกี่ยวกับ การบริจาคร่างกาย', 'บ้าน', '123', '../uploads/line_oa_chat_221129_173000.jpg', '2025-03-19 05:10:22'),
(6, '1619400005271', 'เกี่ยวกับ การบริจาคร่างกาย', 'รพ.นวมินทร์2', 'บริจาคเลือด', '../uploads/messageImage_1670308402138.jpg', '2025-03-19 05:57:42'),
(7, '1103703175319', 'เกี่ยวกับ การบริจาคร่างกาย', 'รพ.นวมินทร์2', 'บริจาคร่างกาย', '../uploads/line_oa_chat_221129_173000.jpg', '2025-03-19 06:47:18'),
(8, '1103703175319', 'เกี่ยวกับ การบริจาคร่างกาย', 'dasdas', 'dsadsads', '../uploads/482356587_949553540691511_4827138769507947260_n.jpg', '2025-03-19 08:09:50');
...
CREATE TABLE `pact` (
  ...
  `officer_id` varchar(13) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `spouse` (
  `spouse_id` varchar(13) COLLATE utf8mb4_unicode_ci NOT NULL,
  `full_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `occupation` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `address` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `income` decimal(10,2) NOT NULL,
...
CREATE TABLE `status` (
  `family_status_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `student` (
  `student_id` varchar(13) COLLATE utf8mb4_unicode_ci NOT NULL,
  `student_code` varchar(13) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'รหัสผ่าน',
  `f_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ชื่อ',
  `l_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'นามสกุล',
  `address` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone_number` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone_number_home` varchar(13) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `profile_image` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `spouse_id` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `father_id` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mother_id` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `guardian_id` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `endorser_id` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `department_id` int(11) DEFAULT NULL,
  `family_status_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `family_status` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL
...
(1, '1103703175319', 1, 'เกี่ยวกับ การบริจาคร่างกาย', 9, '2025-03-19 04:36:46'),
(2, '1103703175319', 1, 'เกี่ยวกับ การบริจาคร่างกาย', 9, '2025-03-19 04:38:13'),
(3, '1103703175319', 1, 'เกี่ยวกับ การบริจาคร่างกาย', 9, '2025-03-19 04:38:35'),
(4, '1103703175319', 1, 'เกี่ยวกับ การบริจาคร่างกาย', 9, '2025-03-19 04:41:51'),
(5, '1103703175319', 1, 'เกี่ยวกับ การบริจาคร่างกาย', 9, '2025-03-19 05:03:59'),
(6, '1103703175319', 22, 'เกี่ยวกับ ลอยกระทง', 18, '2025-03-19 05:08:31'),
(7, '1103703175319', 18, 'เกี่ยวกับ Music Interventions for Enhancing Children Development', 3, '2025-03-19 05:08:37'),
(8, '1103703175319', 13, 'เกี่ยวกับ ขอขวดเป็นของขวัญ', 18, '2025-03-19 05:09:33'),
(9, '1103703175319', 13, 'เกี่ยวกับ ขอขวดเป็นของขวัญ', 18, '2025-03-19 05:09:54'),
(10, '1619400005271', 1, 'เกี่ยวกับ การบริจาคร่างกาย', 9, '2025-03-19 05:56:35'),
(11, '1103703175319', 6, 'เกี่ยวกับ อาสาสมัคร (เฉพาะผู้มีบัตรจิตอาสา)', 18, '2025-03-19 06:46:23'),
(12, '1103703175319', 2, 'เกี่ยวกับ ทำความสะอาด', 4, '2025-03-19 06:46:41'),
(13, '1103703175319', 1, 'เกี่ยวกับ การบริจาคร่างกาย', 9, '2025-03-19 08:09:40');
...
CREATE TABLE `volunteer` (
  `certifier_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
