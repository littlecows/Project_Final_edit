...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE teacher SET password='$password',f_name='$f_name', l_name='$l_name', campus='$campus',, room_number='$room_number', position='$position' WHERE officer_id=$officer_id";
