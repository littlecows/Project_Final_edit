...
(1, 'DevBabe', 'moombabe24468@gmail.com', '$2y$10$fUeaSp6ivzSFWk3UnpT5uubJ/yrEHKyP4zj5l6jgfgWSAzTPYucJW');
...
('F123', 'สมชาย', 'ใจดี', 'พนักงานบริษัท', '123 หมู่ 4 ตำบลทดสอบ อำเภอเมือง จังหวัดกรุงเท', '40300.00', '0812345679', 'ปริญญาตรี', 'มหาวิทยาลัย A'),
...
('M456', 'สมฤดี', 'ใจดี', 'พนักงานบริษัท', '500 หมู่ 7 ตำบลทดสอบ อำเภอเมือง จังหวัดเชียงใหม่', '36030.00', '0845556641', 'ปริญญาตรี', 'มหาวิทยาลัย GHJ'),
...
CREATE TABLE `student` (
  ...
  `address` varchar(255) NOT NULL,
  `phone_number` varchar(10) NOT NULL,
  `phone_number_home` varchar(10) NOT NULL COMMENT 'เบอร์โทรศัพท์บ้าน',
  ...
  `family_status` varchar(255) NOT NULL COMMENT 'สถานภาพครอบครัว'
...
('1103703175319', '620406400925', '$2y$10$/ODQjkjLWEvCP0Tw0gVYa.QZ3fY/mb0Oa4INGNcaZDQifWvHKVlbi', 'Trisit', 'Worrakittongau', '123 ถนนสุขุมวิท กรุงเทพฯ', '0989925145', '-', 'moombabe@gmail.com', '/xampp/htdocs/Project_Final/uploads/HBDPwy.jpg', 'S001', 'F123', 'M456', 'G123', '2', '1282627462415', '1', 'สมรส'),
('1234567890123', '62040640099', '$2y$10$F1Ou5uFiGD/vKbzrvUObR.qpSkobXuKsBh2qMQUp3OCBpLQXJ.Px.', 'test', 'test', 'test', '1234567890', '', 'test@gmail.com', NULL, NULL, '', '', NULL, NULL, NULL, NULL, ''),
('1234567890124', '1001', 'password124', 'ไตรสิทธิ๋์', 'โลภมาก', '123 ถนนสุขุมวิท กรุงเทพฯ', '0812345678', '', 'somchai@email.com', NULL, NULL, '', '', NULL, NULL, NULL, '1', ''),
('222222222222', '', '$2y$10$F3UcgUsg3C3WgTJQRsKNqOGWi9k012wK/uAn1GTODeJ8xt8/b6kuC', 'Pana', 'Ma', '', '0998928827', '', 'house253689@gmail.com', NULL, NULL, '', '', NULL, NULL, NULL, NULL, ''),
('2345678901234', '1002', 'password234', 'สมหญิง', 'สบายใจ', '456 ถนนพหลโยธิน กรุงเทพฯ', '0898765432', '', 'somying@email.com', NULL, NULL, '', '', NULL, NULL, NULL, '2', ''),
('3456789012345', '1003', 'password345', 'สมศักดิ์', 'สุดยอด', '789 ถนนพลโยธิน กรุงเทพฯ', '0876543210', '', 'anan@email.com', NULL, NULL, '', '', NULL, NULL, NULL, '1', '');
...
('5', '$2y$10$ibsZBWQaU9pheOGGPrSm9.Mxdm.AiYvR1H78Yw2kqCH9HSEqG81k2', 'Trisit', 'Worrakittongau', 'KBU', 'R2618', 'Bigboss', '/xampp/htdocs/Project_Final/uploads/98184109_895677447563683_1104361066759979008_n.jpg');
